...
public sealed class OrderProcessingSagaTests
{
    ...
    private static OrderPlacedIntegrationEvent OrderPlaced(Guid orderId, params Guid[] productIds) =>
        new()
        {
            Id = NewId.NextGuid(),
    ...
    private static StockReservedIntegrationEvent StockReserved(Guid orderId, Guid productId) =>
        new()
        {
            Id = NewId.NextGuid(),
            OccurredOnUtc = DateTime.UtcNow,
    ...
    private static PaymentSucceededIntegrationEvent PaymentSucceeded(Guid orderId) =>
        new()
        {
            Id = NewId.NextGuid(),
            OccurredOnUtc = DateTime.UtcNow,
    ...
    private static StockReservationConfirmedIntegrationEvent StockReservationConfirmed(Guid orderId, Guid productId) =>
        new()
        {
            Id = NewId.NextGuid(),
            OccurredOnUtc = DateTime.UtcNow,
