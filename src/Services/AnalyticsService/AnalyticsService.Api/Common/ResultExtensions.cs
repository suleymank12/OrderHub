...
namespace OrderHub.AnalyticsService.Api.Common;

/// <summary>
/// Handler'ın döndürdüğü başarısız <see cref="Result"/>'ı RFC 7807 <see cref="ProblemDetails"/> yanıtına
/// çevirir (read-side'da pratikte yalnız NotFound). Validation exception'larını ise <c>GlobalExceptionHandler</c>
/// ele alır (iki ayrı çeviri yolu, bilinçli).
/// </summary>
