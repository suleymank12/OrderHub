...
namespace OrderHub.PaymentService.Api.Identity;

/// <summary>
/// JWT doğrulama ayarları. <b>Secret asla appsettings'te tutulmaz</b> (K3) → user-secrets (dev) veya env var
/// <c>JwtSettings__Secret</c> (prod). DataAnnotations + <c>ValidateOnStart</c> ile eksik/kısa secret
/// <b>startup'ta</b> fail-fast eder. PaymentService token üretmez (yalnız doğrular); üretim Gateway/Order'da.
/// </summary>
